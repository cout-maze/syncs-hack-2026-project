    ...
    <div className="grid min-h-dvh place-items-center bg-paper-50 bg-blueprint px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="mb-7 text-center">
          <p className="font-display text-[11px] font-bold tracking-[0.3em] text-honey-deep uppercase">
            The Missing Block
          </p>
        ...
        <div className="rounded-card border border-line bg-paper-0 p-6 shadow-2xl shadow-black/10">
          {children}
        </div>
